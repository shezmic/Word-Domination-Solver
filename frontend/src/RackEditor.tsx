  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h3 className="text-lg font-semibold text-gray-800">Your Rack</h3>
      </div>
